...
f = open('../Experiment Logs/' + cas9 + '_crisprpred++_log.txt', 'w')
...
f = open('../Experiment Models/crisprpred++_sfm_' + cas9 + '.pkl', 'wb')
pkl.dump(sfm, f)

f = open('../Experiment Models/crisprpred++_rf_' + cas9 + '.pkl', 'wb')
pkl.dump(trained_rf, f)

f = open('../Experiment Models/crisprpred++_scaler_' + cas9 + '.pkl', 'wb')
pkl.dump(scaler, f)

svm.save_to_file('../Experiment Models/crisprpred++_svm_' + cas9 + '.txt')
